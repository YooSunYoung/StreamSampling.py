...
project = 'StreamSampling'
copyright = '2026 Yoosunyoung contributors'
author = 'Yoosunyoung contributors'
...
try:
    release = get_version("streamsampling")
...
htmlhelp_basename = 'streamsamplingdoc'
